...
class TestCELI_CFQ4ImpRegression(unittest.TestCase):
    ...
    def test_celi_cfq4_imp(self):
        ...
        opendeplete.celi_cfq4_imp(op, print_out=False)
        ...
        s1 = [2.0323719390596913, 1.1667340069641805]
        s2 = [2.6951968774794537, 0.3757514683905956]
