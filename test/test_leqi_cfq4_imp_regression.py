...
class TestLEQI_CFQ4ImpRegression(unittest.TestCase):
    ...
    def test_leqi_cfq4_imp(self):
        ...
        opendeplete.leqi_cfq4_imp(op, print_out=False)
        ...
        s1 = [1.7059974677730223, 1.194797183185515]
        s2 = [2.172619780756002, 1.4240902543717193]
        s3 = [2.3609692573599297, 2.923413774212062]
